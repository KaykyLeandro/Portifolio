            ...
            `}>
                ...
                <div className="flex flex-col items-center gap-10 w-full md:flex-row">
                    ...
                    <div className="flex justify-evenly flex-col gap-5 box-border md:w-1/2">
                        ...
                        <h3 className="text-xl font-quicksand text-primary md:text-3xl font-black">
                            {props.project?.name}
                        </h3>
                        ...
                        <Link href={props.project?.link ?? ''} className="py-3 px-6 self-center w-fit bg-primary font-bold font-quicksand text-background rounded hover:scale-110 hover:bg-foreground transition duration-100">
                            Acessar
                        </Link>
                    ...
                    {/* PROJECT GALERY */}
                    <div className="flex flex-col gap-3 justify-center items-center box-border bg-[rgba(128,128,128,0.1)] p-2 pt-5 rounded-xl md:w-1/2 md:p-5">
